...
public class FxLunar {
    ...
    public static void main(String[] args) {
        //计算录入年份是否有闰月
        System.out.println(leapMonth(2023));
        //传回农历 year年month月的总天数，总共有13个月包括闰月
        System.out.println(daysInLunarMonth(2023,2));
        //传回农历year年month月的总天数
        System.out.println(daysInMonth(2023,2,true));
        //阳历转阴历  9.25  10.23 有问题
        System.out.println(Arrays.toString(solarToLunar(2023, 3, 17)));
        System.out.println(Arrays.toString(solarToLunar(2024, 1, 1)));
        //阴历转阳历
        System.out.println(Arrays.toString(lunarToSolar(2023,3,2,true)));
    }
}
