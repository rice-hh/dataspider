...
public class HttpUtil {
     ...
     * @return
     */
  	public static String sendHttpJsonPost(String url,JSONObject params) {
  		String result = "";
  		try {
  	...
  	public static String sendHttpJsonHeaderPost(String url,JSONObject params, Map<String, Object> headers) {
  		String result = "";
  		try {
  			HttpURLConnection conn = (HttpURLConnection) new URL(url).openConnection();
  	        conn.setConnectTimeout(5000);
  	...
  	public static String sendHttpsJsonHeaderPost(String url,JSONObject params, Map<String, Object> headers) {
  		String result = "";
  		try {
...
//        httpPost.setEntity(reqEntity);
     ...
     * @return
     */
    public static String sendHttpHeaderPost(String httpUrl, Map<String, Object> headers) {
    	// 创建httpPost
        HttpPost httpPost = new HttpPost(httpUrl);
        for (Map.Entry<String, Object> entry : headers.entrySet()) {
            String key = entry.getKey().toString();
     ...
     * @return
     */
    public static String sendHttpHeaderPost(String httpUrl, Map<String, Object> headers, SSLContext sslConext) {
    	// 创建httpPost
        HttpPost httpPost = new HttpPost(httpUrl);
        for (Map.Entry<String, Object> entry : headers.entrySet()) {
            String key = entry.getKey().toString();
        ...
        return sendHttpPost(httpPost, sslConext);
    }
     ...
     * @return
     */
    public static String sendHttpHeaderGet(String httpUrl, Map<String, Object> headers) {
        // 创建get请求
        HttpGet httpGet = new HttpGet(httpUrl);
        for (Map.Entry<String, Object> entry : headers.entrySet()) {
            String key = entry.getKey().toString();
    ...
    public static String sendHttpHeaderGet(String httpUrl, Map<String, Object> headers, SSLContext sslConext) {
        // 创建get请求
        HttpGet httpGet = new HttpGet(httpUrl);
        for (Map.Entry<String, Object> entry : headers.entrySet()) {
            String key = entry.getKey().toString();
